...
app = Flask(__name__)
model = load_model(r"D:\vit\INTERNSHIP\AI\Team 443 Brain Tumor\SI-GuidedProject-4596-1626951146-main\SI-GuidedProject-4596-1626951146-main\Brain_Tumor.h5")
